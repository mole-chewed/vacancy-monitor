...
from hh_monitor import keywords
from hh_monitor.models import TrackAssessment, Vacancy, VacancyTrack
...
def classify_vacancy(vacancy: Vacancy) -> TrackAssessment:
    ...
    if (product_title and backend_signal < 5) or (research_title and backend_signal < 5):
