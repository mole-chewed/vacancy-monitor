...
from vacancy_monitor.models import MatchLabel, RankedVacancy, RecommendedAction
from vacancy_monitor.summaries import LABEL_TITLES_RU, format_concerns_ru, format_reasons_ru
