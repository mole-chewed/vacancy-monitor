...
from vacancy_monitor.models import MatchLabel, RecommendedAction, Vacancy, VacancyAnalysis, VacancyTrack, WorkFormat
from vacancy_monitor.summaries import build_expected_salary, build_summary_ru
